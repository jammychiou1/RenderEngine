...
CameraController::CameraController(Camera* camera, glm::vec3 pos, glm::vec2 lng_lat) :
        _camera(camera), _pos(pos), _vel(), _lng_lat(lng_lat), _ang_vel() {}
...
void CameraController::update() {
    ...
    _pos += glm::rotate(_vel, _lng_lat.x, up);
